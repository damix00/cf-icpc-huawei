...
double eBottleW = 1.0;
double remBusyW = 0.0;   // weight on a remote's already-committed work when placing a request   // hold-budget ceiling while the local computer is the bottleneck
