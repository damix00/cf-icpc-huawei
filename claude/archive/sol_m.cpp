...
int holdPreToo = 1;
double mFloor = 0;   // force the wave target to at least this many requests (0 = model only)
...
inline void retarget() {
    ...
    if (mFloor > 0) mStar = max(mStar, (int)min((double)L, mFloor));
